...
This is a ROS stack that contains packages for the simulation and navigation of [Husarion ROSbot](https://husarion.com/manuals/rosbot-manual). This version is based on the original stack is already tested on ROS Melodic.

> To see the original stack for ROS Kinetic click [here](https://github.com/husarion/rosbot_description).

This stack contains URDF model for Gazebo simulation integrated with ROS as well as configuration files for use with ROS [navigation](http://wiki.ros.org/navigation) package.
...
Contains configuration files for ROS [navigation](http://wiki.ros.org/navigation) package.
